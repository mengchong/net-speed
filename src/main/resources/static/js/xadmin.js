;!function (win) {
    ...
    Xadmin.prototype.init = function () {
        ...
        if(_type == "speed"){
            this.add_tab('网络测速', '../networkSpeed/index.html');
        }else if(_type == "statistic"){
            this.add_tab('AP', '../graphical/APIndex.html');
        }else{
            this.add_tab('网络测速', '../networkSpeed/index.html');
        }
...
layui.use(['layer', 'element', 'jquery'], function () {
    ...
    $('#tab_right').on('click', 'dd', function (event) {
        ...
        if (data_type == 'this') {
            ...
            if ($("#" + lay_id).hasClass('active')) {
                $("#" + lay_id).removeClass('active');
            }
            var attr = $('.layui-tab-title').find('li[class=layui-this]').attr('lay-id');
