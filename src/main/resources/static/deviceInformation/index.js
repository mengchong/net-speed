...
layui.use(['laydate', 'form', 'table'], function () {
    ...
    table.render({
        elem: '#contentTable'
        , url: '../vesapp/deviceInformation/list.do' //数据接口
        , page: true //开启分页
        , id: 'tableReload'
        , response: {
        ...
        , cols: [[ //表头
            ...
            , {field: 'localIP', title: '本机IP'}
            , {field: 'extranetIP', title: '外网IP'}
            , {field: 'operatingSystem', title: '操作系统'}
            , {field: 'manufacturer', title: '生产商'}
            , {field: 'deviceID', title: '编号'}
            , {field: 'wlanName', title: '无线名称'}
            , {field: 'macAddress', title: 'mac地址', event: 'setSign'}
    ...
    //监听表格
    /*table.on('tool(searchMac)', function (obj) {
        if (obj.event === 'setSign') {
            console.log(obj.data.macAddress);
        }
    });*/
