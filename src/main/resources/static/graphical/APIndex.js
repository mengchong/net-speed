...
layui.use(['laydate', 'form', 'table'], function () {
    ...
    table.render({
        elem: '#contentTable'
        ,
        url: 'http://121.69.196.95:1284/vesapp/static/ap.do?limit=' + $('#TOP input[name="TOP"]:checked ').val() + '&dateTye=' + $('#lastTime input[name="lastTime"]:checked ').val()//数据接口
        ,
        page: false //开启分页
        ,
        limit: 0
    ...
    var active = {
        reload: function () {
            ...
            table.reload('tableReload', {
                page: false
                , url: 'http://121.69.196.95:1284/vesapp/static/ap.do'
                , where: {
